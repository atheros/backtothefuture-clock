...
static const unsigned int font[] = {
   ...
   /* 27 - 1 */ ~(SEG_H | SEG_M),
   /* 28 - 2 */ ~(SEG_A | SEG_B | SEG_D | SEG_E | SEG_P | SEG_K),
   /* 29 - 3 */ ~(SEG_A | SEG_B | SEG_C | SEG_D | SEG_P | SEG_K),
   /* 30 - 4 */ ~(SEG_B | SEG_C | SEG_F | SEG_P | SEG_K),
   /* 31 - 5 */ ~(SEG_A | SEG_C | SEG_D | SEG_F | SEG_P | SEG_K),
   /* 32 - 6 */ ~(SEG_A | SEG_C | SEG_D | SEG_E | SEG_F | SEG_P | SEG_K),
   /* 33 - 7 */ ~(SEG_A | SEG_B | SEG_C),
   /* 34 - 8 */ ~(SEG_A | SEG_B | SEG_C | SEG_D | SEG_E | SEG_F | SEG_P | SEG_K),
   /* 35 - 9 */ ~(SEG_A | SEG_B | SEG_C | SEG_D | SEG_F | SEG_P | SEG_K),
   /* 36 - 0 */ ~(SEG_A | SEG_B | SEG_C | SEG_D | SEG_E | SEG_F | SEG_J | SEG_N),
   /* 37 - . */ ~(SEG_DOT),
   /* 38 - ' */ ~(SEG_H),
   /* 39 - " */ ~(SEG_F | SEG_H),
   /* 40 - - */ ~(SEG_P | SEG_K),
